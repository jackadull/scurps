...
object Rule {
  type Rule0[+R] = Rule[({type P[A[+_]]=Unit})#P,R]
  type Rule1[-T1,+R] = Rule[({type P[A[+_]]=A[T1]})#P,R]
  type Rule2[-T1,-T2,+R] = Rule[({type P[A[+_]]=(A[T1],A[T2])})#P,R]
  type Rule3[-T1,-T2,-T3,+R] = Rule[({type P[A[+_]]=(A[T1],A[T2],A[T3])})#P,R]
}
