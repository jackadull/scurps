...
object Rule {
  type RuleA0[+R] = Rule[({type P[A[+_]]=Params0})#P,R]
  type RuleA1[-T1,+R] = Rule[({type P[A[+_]]=Params1[A[T1]]})#P,R]
  type RuleA2[-T1,-T2,+R] = Rule[({type P[A[+_]]=Params2[A[T1],A[T2]]})#P,R]
  type RuleA3[-T1,-T2,-T3,+R] = Rule[({type P[A[+_]]=Params3[A[T1],A[T2],A[T3]]})#P,R]
}
