...
object PerceptionRule extends AdjustableSecondaryCharacteristicRule.Specific[Int] {
  ...
  private[attributes] def resolveSCRule(rules:GRules) = rules perceptionRule
}
